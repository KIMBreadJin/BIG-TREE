  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function login() {
        ...
        var email2 = document.getElementById('email_site').value
          ...
          <form class="form-horizontal" method="post" name="register" action="register">
            ...
            <div class="form-group">
              ...
              <div class="col-md-5 col-sm-8">
                ...
                <button class="btn btn-info btn-xs" type="button" id="idChk" onclick="fn_idChk()" value="N" style="display: inline">
                  ID중복확인
                </button>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-xs-offset-3 col-md-8 col-sm-9">
                <span class="text-muted"
                  ><span class="label label-danger">Note:-</span> ' <span class="text-danger">*</span> '표는 필수 입력란 입니다.</span
                >
              </div>
            </div>
            <div class="form-group">
